package com.michael_perez.android.stockhawk.ui;
...
import com.michael_perez.android.stockhawk.rest.QuoteCursorAdapter;
import com.michael_perez.android.stockhawk.rest.RecyclerViewItemClickListener;
import com.michael_perez.android.stockhawk.rest.Utils;
import com.michael_perez.android.stockhawk.service.StockIntentService;
import com.michael_perez.android.stockhawk.service.StockTaskService;
import com.google.android.gms.gcm.GcmNetworkManager;
import com.google.android.gms.gcm.PeriodicTask;
import com.google.android.gms.gcm.Task;
import com.melnykov.fab.FloatingActionButton;
import com.michael_perez.android.stockhawk.stock_history.realm.RealmController;
import com.michael_perez.android.stockhawk.touch_helper.SimpleItemTouchHelperCallback;
import com.michael_perez.android.stockhawk.ui.graph.GraphActivity;
...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null){
            ...
            mServiceIntent.putExtra(Constants.KEY_TAG, Constants.VAL_TAG_INIT);
//            mServiceIntent.putExtra(Constants.KEY_TAG, Constants.VAL_TAG_ADD);
            mServiceIntent.putExtra(Constants.KEY_STOCK_SYMBOL,Constants.STOCK_SYMBOL_YHOO);
            if (isConnected){
